        ...
        <div className="flex md:flex-col ">
          ...
          <div className="right relative flex-1 flex flex-wrap p-5 gap-10 items-center justify-center sm:w-full">
            ...
            <p>Front-end</p>
              ...
              />
                <SkillBox
                logo={ <img src={require('../../assets/mysql.png')}></img>}
                black={"white"}
                white={"black"}
                skill={"My sql"}
              />
            ...
            <div className="last2 flex flex-col gap-10">
              <p>Back-End</p>
              <SkillBox
                logo={ <img src="https://img.icons8.com/color/48/null/python--v1.png"></img>}
                black={"black"}
                white={"white"}
                skill={"Python"}
              />
              <SkillBox
                className=""
                  logo={ <img src={require('../../assets/django.png')}></img>}
                black={"black"}
                white={"white"}
                skill={"Django"}
              />
              <SkillBox
                className=""
                logo={ <img src={require('../../assets/api.png')}></img>}
                black={"black"}
                white={"white"}
                skill={"API"}
              />
